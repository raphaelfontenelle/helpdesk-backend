...
import com.fontenelle.helpdesk.domain.dtos.ClienteDTO;
import com.fontenelle.helpdesk.repository.ClienteRepository;
import com.fontenelle.helpdesk.repository.PessoaRepository;
import com.fontenelle.helpdesk.services.exception.DataIntegrityViolationException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		if (obj.getChamados().size() > 0) {
			throw new DataIntegrityViolationException("Cliente possui ordens de serviço e nào pode ser deletado");
